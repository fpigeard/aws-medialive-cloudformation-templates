...
|---|---|---|---|
| [Single H264](CloudFormation_Single_EML-H264_EMPv2_CloudFront.yaml) | H.264 | CBR | Standard |
...
| [HEVC](CloudFormation_EML-HEVC_MediaPackagev2_CloudFront.yaml) | H.265 (HEVC) | - | Standard |
